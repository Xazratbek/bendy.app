...
struct FoldStyle: Equatable, Identifiable, Codable, Sendable {
    let id: String
    let name: String
    let blurb: String
    ...
    static let satin = FoldStyle(
        id: "satin",
        name: "Silk",
        blurb: "Smooth and glossy, with light gliding across the desktop.",
        perspective: 0.85,
        blurRadius: 300,
        darkening: 0.35,
        shadowStrength: 0.75,
    ...
    static let eclipse = FoldStyle(
        id: "eclipse",
        name: "Shade",
        blurb: "Deep shadow. The desktop settles into black as the lid closes.",
        perspective: 1.00,
        blurRadius: 380,
        darkening: 0.60,
        shadowStrength: 1.00,
    ...
    static let glacier = FoldStyle(
        id: "glacier",
        name: "Frost",
        blurb: "Frosted glass. Everything softens before it disappears.",
        perspective: 0.75,
        blurRadius: 620,
        darkening: 0.25,
        shadowStrength: 0.60,
